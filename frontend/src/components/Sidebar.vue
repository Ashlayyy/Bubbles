...
<template>
  <div class="fixed left-0 top-0 h-full w-64 bg-card border-r border-border flex flex-col">
    <!-- Header -->
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'Moderation' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'ReactionRoles' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'CustomCommands' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'CommandAliases' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'Automation' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M12 2v6"/>
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'Applications' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <router-link
        ...
        class="flex items-center space-x-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors"
        :class="{ 'bg-secondary text-foreground': $route.name === 'Entertainment' }"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <line x1="6" y1="3" x2="6" y2="15"/>
          <circle cx="18" cy="6" r="3"/>
          <circle cx="6" cy="18" r="3"/>
          <path d="m18 9 2.26-2.26a1.5 1.5 0 0 1 2.12 0l1.38 1.38a1.5 1.5 0 0 1 0 2.12L21.5 12.5"/>
        </svg>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
          <div class="w-8 h-8 bg-gradient-to-br from-green-500 to-blue-500 rounded-full flex items-center justify-center">
            <span class="text-primary-foreground text-xs font-bold">{{ currentGuild?.name?.charAt(0) || 'D' }}</span>
          </div>
          <div>
            <p class="text-sm font-medium text-foreground truncate max-w-[120px]">{{ currentGuild?.name || 'Demo Server' }}</p>
            <p class="text-xs text-muted-foreground">{{ memberCount }} members</p>
          </div>
        </div>
        <ThemeToggle />
      </div>
...
const memberCount = computed(() => {
  return currentGuildStats.value?.memberCount ? 
    new Intl.NumberFormat().format(currentGuildStats.value.memberCount) : 
    '12,346'
})
</script>
