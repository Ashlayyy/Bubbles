...
<template>
  <div class="bg-slate-900 border border-slate-800 rounded-xl">
    <div class="p-6 border-b border-slate-800">
      ...
      <p class="text-slate-400 mt-1">Events triggered by users in these roles, or in these channels will not be logged.</p>
    </div>
    <div class="p-6">
...
const saveChanges = () => {
  ...
  toastStore.addToast('Log ignore settings saved!', 'success');
};
</script>
