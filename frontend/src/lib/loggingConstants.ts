export const LOG_CATEGORIES = {
	...
	REACTION_ROLE: [
		...
		'REACTION_ROLE_CONFIG_ADD',
		'REACTION_ROLE_CONFIG_REMOVE',
		'REACTION_ROLE_MESSAGE_CREATE',
		'REACTION_ROLE_MESSAGE_UPDATE',
		'REACTION_ROLE_MESSAGE_DELETE',
		'REACTION_ROLE_ERROR',
	],
	AUTOMOD: [
		'AUTOMOD_RULE_CREATE',
...
export type LogEvent = (typeof LOG_CATEGORIES)[LogCategory][number];

export const STANDARD_LOG_TYPES: readonly LogEvent[] = Object.entries(
	LOG_CATEGORIES
)
	.filter(([category]) => category !== 'HIGH_VOLUME')
	.flatMap(([, types]) => types)
	.filter((type) => {
		const excludeSpecific: LogEvent[] = [
			'APPLICATION_COMMAND_USE',
			'COMMAND_USERINFO',
			'COMMAND_SERVERINFO',
			'COMMAND_AVATAR',
...
export const LOGGING_PRESETS = [
	...
	},
	{
		...
		emoji: '👥',
		logTypes: [
			...LOG_CATEGORIES.MESSAGE.filter(
				(type) => !['MESSAGE_CREATE'].includes(type)
			),
			...LOG_CATEGORIES.MEMBER,
